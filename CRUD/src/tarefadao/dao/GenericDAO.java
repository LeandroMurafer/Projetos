...
/*
    ...
    3- Precisa passar para o GenericDAO a classe que esta herdando
        ex: public class ProdutoDAO extends GenericDAO<Produto>{

        }
    4- precisa ter a classe "IgnoreInDAO" no Projeto
*/
